...
<div id="main_body">
	...
	<div class="container-fluid">
		<!-- 以下是活动的筛选栏 -->
		<div class="row">
			<div id="activity_selection" class="col-md-10">
			...
			if(isset($session['user'])){
				echo "<form action='index.php?r=activity/to-release' method ='post'>";
				echo "<button class='btn btn-lg btn-primary btn-block' type='submit'>发布活动</button>";
				echo "</form>";
			}
			else{
				echo "<h3>请先登录才能发布活动</h3>";
			}
			?>
			</div>
		</div>
...
<?php
$this->registerJsFile('@web/js/activity/activity.js');
?>